...
def add_default_fields_layout(force=False):
	...
	data_fields_layouts = {
		"CRM Lead-Data Fields": {
			"doctype": "CRM Lead",
			"layout": '[{"name":"first_tab","sections":[{"label":"Details","name":"details_section","opened":true,"columns":[{"name":"column_ZgLG","fields":["organization","industry","lead_owner","engagement_type"]},{"name":"column_TbYq","fields":["website","job_title","product_interest","customer_segment"]},{"name":"column_OKSX","fields":["territory","source","application","designation"]}]},{"label":"Person","name":"person_section","opened":true,"columns":[{"name":"column_6c5g","fields":["salutation","email"]},{"name":"column_1n7Q","fields":["first_name","mobile_no"]},{"name":"column_cT6C","fields":["last_name"]}]}]}]',
		},
